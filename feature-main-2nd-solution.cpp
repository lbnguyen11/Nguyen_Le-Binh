//
//  feature-main-2nd-solution.cpp
//  CppGraphTest
//
//  Created by lgb1hc on 21/08/2024.
//  Tested on Ubuntu 22.04.3 LTS
//  
//  This program determines whether or not an undirected graph contains a cycle by doing:
...
//    4. Revise the design and provide implementation for special member functions of BfsVertex and BfsGraph classes if necessary.
//    5. Research ways to draw undirected grpah for testing. 
...
namespace {
  const vector<Edge> defaultEdges
    { {10,14},{12,13},{11,17},{12,15},{12,16},{14,15} };
}

vector<Edge> createEdges (bool useDefault)
{
  cout << "*****createEdges*****start\n";
  int i, j, k, nodes = 0;
  srand (time (NULL));
...
bool has_cycle(const vector<Edge> &edges) {
  ...
  //step2: create an BfsGraph and invoke its has_cycle member function
...
//{ {0,5},{0,6},{1,3},{1,4},{2,4},{2,7},{2,9},{3,8},{5,8},{7,7} }; // self cycle at vertex 7
//{ {0,6},{1,4},{1,8},{2,8},{4,8},{5,8},{6,8} };
...
//{ {10,14},{12,13},{11,17},{12,15},{12,16},{14,15} };//disjoint sets
